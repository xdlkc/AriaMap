        ...
        public void onClick(View v) {
            switch (v.getId()) {
                case R.id.login_btn_register:                            //登录界面的注册按钮
                    Intent intent_Login_to_Register = new Intent(dengluActivity.this,zhuceActivity.class) ;    //切换Login Activity至User Activity
                ...
                case R.id.login_text_change_pwd:                             //登录界面的注销按钮
                    Intent intent_Login_to_reset = new Intent(dengluActivity.this,chongzhimimaActivity.class) ;    //切换Login Activity至User Activity
    ...
    public void login() {                                              //登录按钮监听事件
        if (isUserNameAndPwdValid()) {
            ...
            if(result==1){                                             //返回1说明用户名和密码均正确
                ...
                Intent intent = new Intent(dengluActivity.this,gerenzhongxinActivity.class) ;    //切换Login Activity至User Activity
